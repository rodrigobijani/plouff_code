...
OBJS = $(BLD)geometric_mod.o $(BLD)obs_mod.o
...
TESTS = test_geometric_mod test_obs_mod
...
test_obs_mod: $(TEST)test_obs_mod.f95 $(OBJS)
	$(F90) $(F90FLAGS) $(OBJS) -o $(EXE)test_obs_mod $(TEST)test_obs_mod.f95
...
$(BLD)obs_mod.o: $(SRC)obs_mod.f95
	$(F90) $(F90FLAGS) -c $(SRC)obs_mod.f95 -o $(BLD)obs_mod.o  
